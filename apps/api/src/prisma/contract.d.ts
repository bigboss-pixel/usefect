...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly BookCopy: {
      ...
      readonly homeLocation: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly Category: {
    ...
    readonly Loan: {
      ...
      readonly returnRequestedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
      readonly returnRequestStatus: CodecTypes['pg/text@1']['output'];
      readonly status: CodecTypes['pg/text@1']['output'];
    ...
    readonly MemberQr: {
      ...
      readonly tokenEncrypted: CodecTypes['pg/text@1']['output'] | null;
    ...
    readonly Reservation: {
      ...
      readonly pickedUpAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly BookCopy: {
      ...
      readonly homeLocation: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly Category: {
    ...
    readonly Loan: {
      ...
      readonly returnRequestedAt: CodecTypes['pg/timestamptz-string@1']['input'] | null;
      readonly returnRequestStatus: CodecTypes['pg/text@1']['input'];
      readonly status: CodecTypes['pg/text@1']['input'];
    ...
    readonly MemberQr: {
      ...
      readonly tokenEncrypted: CodecTypes['pg/text@1']['input'] | null;
...
export namespace Models {
  ...
  export type public_Book = {
    ...
    reservations: public_Reservation[];
    readonly [RelationKeys]?: 'category' | 'copies' | 'reservations';
  };
  export type public_BookCopy = {
    ...
    homeLocation: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    book: public_Book;
    loans: public_Loan[];
  ...
  export type public_Reservation = {
    ...
    pickedUpAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    ...
    user: public_User;
    readonly [RelationKeys]?: 'book' | 'loan' | 'user';
  };
  export type public_Loan = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    bookCopyId: CodecTypes['pg/int4@1']['output'];
    reservationId: CodecTypes['pg/int4@1']['output'] | null;
    ...
    returnRequestedAt: CodecTypes['pg/timestamptz-string@1']['output'] | null;
    returnRequestStatus: CodecTypes['pg/text@1']['output'];
    status: CodecTypes['pg/text@1']['output'];
    ...
    reservation: public_Reservation | null;
    user: public_User;
    readonly [RelationKeys]?: 'bookCopy' | 'reservation' | 'user';
  };
  ...
  export type public_MemberQr = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    tokenHash: CodecTypes['pg/text@1']['output'];
    tokenEncrypted: CodecTypes['pg/text@1']['output'] | null;
          ...
          readonly table: {
            ...
            readonly reservation: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'reservation_bookId_idx_3eec38a3';
                  readonly prefix: 'reservation_bookId_idx';
                  readonly columns: readonly ['bookId'];
                  readonly unique: false;
                },
                {
      ...
      readonly public: {
        readonly models: {
          ...
          readonly BookCopy: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly homeLocation: { readonly column: 'homeLocation' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly Loan: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly returnRequestedAt: { readonly column: 'returnRequestedAt' };
                readonly returnRequestStatus: { readonly column: 'returnRequestStatus' };
                readonly status: { readonly column: 'status' };
          ...
          readonly MemberQr: {
            ...
            readonly storage: {
              readonly table: 'memberQr';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
                readonly tokenHash: { readonly column: 'tokenHash' };
                readonly tokenEncrypted: { readonly column: 'tokenEncrypted' };
